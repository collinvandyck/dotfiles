...
map('n', 'qg', ':Telescope live_grep<CR>', map_opts)
...
map('n', '<Leader>rl', ':silent! bufdo e<CR>:LspRestart<CR>', map_opts)
map('n', '<Leader>r', ':LspRestart<CR>', map_opts)
...
map('n', '<leader>ve', ':e $MYVIMRC<CR>', map_opts)
map('n', '<leader>R', ':source $MYVIMRC<CR>', map_opts)
map('n', '<Leader>f', ':NvimTreeFindFile<CR>', map_opts)
map('n', '<Leader>n', ':NvimTreeToggle<CR>zz<C-w>=', map_opts)
